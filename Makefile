...
#    Updated: 2023/02/13 11:23:09 by aoudija          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES = mandatory/so_long.c mandatory/get_next_line.c mandatory/fill.c mandatory/ft_utils.c mandatory/img_ptr.c moves/player_down.c moves/player_up.c \
		...
		parsing/check_items.c parsing/is_rectangular.c parsing/check_walls.c is_playable/is_playable.c filler.c bonus/morty_img.c is_playable/player_pos.c ft_split.c ft_strtrim.c\
